...
public class Routenberechnung {
    ...
    public Routenberechnung(){
    	//Knoten Ebene0
    	int[] list0 = {1};
    	Gesamtliste.add(new Knoten(0,0,0,0,list0));
    	int[] list1 = {0,2,3,9};
    	Gesamtliste.add(new Knoten(1,3,0,0,list1));
    	int[] list2 = {1,5};
    	Gesamtliste.add(new Knoten(2,3,3,0,list2));
    	int[] list3 = {1,4,10};
    	Gesamtliste.add(new Knoten(3,12,0,0,list3));
    	int[] list4 = {3,5};
    	Gesamtliste.add(new Knoten(4,15,0,0,list4));
    	int[] list5 = {2,6};
    	Gesamtliste.add(new Knoten(5,16,7,0,list5));
    	int[] list6 = {5,7};
    	Gesamtliste.add(new Knoten(6,17,10,0,list6));
    	int[] list7 = {6};
    	Gesamtliste.add(new Knoten(7,17,13,0,list7));
    	//Knoten Ebene1
    	int[] list8 = {9};
    	Gesamtliste.add(new Knoten(8,0,0,5,list8));
    	int[] list9 = {1,8,10};
    	Gesamtliste.add(new Knoten(9,3,0,5,list9));
    	int[] list10 = {9,3};
    	Gesamtliste.add(new Knoten(10,3,3,5,list10));
