...
public class DataBase {
	...
	private static final String TABLE_NAME = "database"; // Tabellenname

	// Spaltennamen der Tabelle
	private static final String NODE_ID = "node_id"; // Knoten ID
	private static final String ROOM = "room"; // Raum
	private static final String FLOOR = "floor"; // Ebene
	private static final String X_VALUE = "x_value"; // x-Wert
	private static final String Y_VALUE = "y_value"; // y-Wert
	private static final String Z_VALUE = "z_value"; // z-Wert
	private static final String NEIGHBOUR_1 = "neighbour_1"; // Nachbar 1
	private static final String NEIGHBOUR_2 = "neighbour_2"; // Nachbar 2
	private static final String NEIGHBOUR_3 = "neighbour_3"; // Nachbar 3
	private static final String NEIGHBOUR_4 = "neighbour_4"; // Nachbar 4
	...
	public Cursor getDatafromNodeId(int node_id) {
		...
		Cursor c = db.query(TABLE_NAME, FROM, "NODE_ID like " + node_id, null, null, null, null); // Abfrage auf Knoten ID
		return c;
	}
	...
	public Cursor getDatafromRoom(String room) {
		db = openHelper.getReadableDatabase(); // Lesezugriff holen
		Cursor c = db.query(TABLE_NAME, FROM, "ROOM like " + room, null, null, null, null); // Abfrage auf Raumnummer
		return c;
	}
	...
	private class DataBaseOpenHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) { // Datenbank mit allen Spalten erzeugen
			db.execSQL("CREATE TABLE " + TABLE_NAME + " (" + _ID
					+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + NODE_ID
					+ " INTEGER," + ROOM + " TEXT NOT NULL," + FLOOR
					+ " INTEGER," + X_VALUE + " INTEGER," + Y_VALUE
					+ " INTEGER," + Z_VALUE + " INTEGER," + NEIGHBOUR_1
					+ " INTEGER," + NEIGHBOUR_2 + " INTEGER," + NEIGHBOUR_3
					+ " INTEGER," + NEIGHBOUR_4 + " INTEGER);");
		}
