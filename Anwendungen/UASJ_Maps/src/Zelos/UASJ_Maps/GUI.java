...
//		
//	
//		myDB.WriteCSVintoDataBase(FileName);	//CSV-Datei in Datenbank �bertragen
	}
	...
	private void launch_state_2() { // Look up Location (B3)
		...
		go.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) { // TODO enable wenn verf�gbar
				String room = new String(RS.getString()); // String des ausgew�hlten Raums holen
